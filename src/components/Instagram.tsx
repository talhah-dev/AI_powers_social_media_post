...
export default function Instagram() {
    ...
    const [caption, setCaption] = useState("Daily Zernio update");
    const [mediaUrl, setMediaUrl] = useState("https://images.unsplash.com/photo-1780174604948-a314f7c98746?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxMHx8fGVufDB8fHx8fA%3D%3D");
    ...
    async function handleSubmit(event: FormEvent<HTMLFormElement>) {
        ...
        try {
            ...
            if (!url) {
                throw new Error("Add a media URL.");
            }
                        ...
                        <form className="space-y-5" onSubmit={handleSubmit}>
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    placeholder="Paste one direct image or video URL"
                                />
                            ...
                            <div className="rounded-xl border border-dashed border-pink-200 bg-pink-50/50 p-4 text-sm text-gray-600">
                                {postType === "story"
                                    ...
                                    : postType === "reel"
                                        ...
                                        : "Feed uses the default Zernio post type."}
                            </div>
